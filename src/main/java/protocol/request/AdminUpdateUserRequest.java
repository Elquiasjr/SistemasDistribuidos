...
public class AdminUpdateUserRequest extends Request<AdminUpdateUserRequest.Payload>{
    ...
    public AdminUpdateUserRequest(String token, Long registro, @Optional String email, @Optional String nome, @Optional String senha, @Optional Boolean tipo){
    ...
    public record Payload(
            @Positive(message = "registro must be positive")
            Long registro,
